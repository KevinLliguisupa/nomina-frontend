...
const ShowTitulo = () => {
    ...
    const getNivel = async () => {
        const response = await axios.get('http://localhost:3000/nominaweb/api/v1/nivel');
    ...
    const PostTitulo = async () => {
        ...
        await axios.post("http://localhost:3000/nominaweb/api/v1/titulo", formData).then(response => {
            getTitulo();
        }).catch(error => {
